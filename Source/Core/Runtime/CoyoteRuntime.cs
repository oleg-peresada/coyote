...
namespace Microsoft.Coyote.Runtime
{
    ...
    {
        private readonly List<AsyncOperation> AsyncStateMachineOwnerOperationsList = new List<AsyncOperation>();
        ...
        internal Task ScheduleDelay(TimeSpan delay, CancellationToken cancellationToken)
        {
            ...
            if (this.SchedulingPolicy is SchedulingPolicy.Systematic)
            {
                ...
                // FN_TODO: should we set some metadata in the AsyncOperation for delays here
