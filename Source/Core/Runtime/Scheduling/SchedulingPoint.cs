...
namespace Microsoft.Coyote.Runtime
{
    ...
    public static class SchedulingPoint
    {
        ...
        public static void Interleave()
        {
            ...
            {
                runtime.ScheduleNextOperation(AsyncOperationType.Default, checkCaller: true);
            }
        }
        ...
        public static void Yield()
        {
            ...
            if (runtime.SchedulingPolicy is SchedulingPolicy.Systematic)
            {
                runtime.ScheduleNextOperation(AsyncOperationType.Yield, isYielding: true, checkCaller: true);
            }
        }
